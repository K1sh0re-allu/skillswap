...
const SkillListingScreen = () => {
  ...
  const userSkills = [
    { username: 'user1', skill: 'Web Development', description: 'Experienced in HTML, CSS, and JavaScript. Familiar with React framework.' },
    { username: 'user2', skill: 'Graphic Design', description: 'Proficient in Adobe Photoshop and Illustrator. Specialized in logo design and branding.' },
    { username: 'user3', skill: 'Mobile App Development', description: 'Skilled in developing cross-platform mobile applications using React Native. Experience with RESTful APIs.' },
  ...
  const handleSubmitDescription = (skill, description) => {
    ...
    console.log('A message is sent to the developer');
  };
...
export default SkillListingScreen;
